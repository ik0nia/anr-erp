 ...
 *
 * Exemplu crontab (Linux): * * * * * php /path/to/htdocs/crm-anr-bihor/cron_newsletter.php
 * Windows Task Scheduler: php.exe "C:\xampp\htdocs\crm-anr-bihor\cron_newsletter.php"
 *
