...
$routes = [
    ...
    '/fundraising/formular-230' => ['type' => 'controller', 'script' => 'fundraising-formular-230.php', 'file' => 'app/controllers/fundraising/public-form.php'],
    ...
    '/api/cauta-participanti'      => ['type' => 'legacy', 'script' => 'api-cauta-participanti.php',      'file' => 'api/cauta-participanti-liste.php'],
    '/api/cauta-participanti-liste'=> ['type' => 'legacy', 'script' => 'api-cauta-participanti-liste.php','file' => 'api/cauta-participanti-liste.php'],
    ...
    '/api/membri-documente-sterge' => ['type' => 'legacy', 'script' => 'membri-documente-sterge.php',    'file' => 'api/membri-documente-sterge.php'],
    ...
    '/util/print-document-generat.php' => ['type' => 'legacy', 'script' => 'print-document-generat.php', 'file' => 'util/print-document-generat.php'],
];
