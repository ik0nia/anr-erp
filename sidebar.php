...
<aside id="navigation" class="w-64 lg:w-64 bg-slate-900 dark:bg-slate-800 text-white flex flex-col shrink-0" role="navigation" aria-label="Navigație principală">
    ...
    <nav class="flex-1 p-4 space-y-0.5 overflow-y-auto text-center" aria-label="Meniu module">
        <a href="/dashboard" class="flex items-center justify-center py-2.5 px-3 hover:bg-slate-700 dark:hover:bg-slate-600 rounded transition focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-slate-900 dark:focus:ring-offset-slate-800" aria-label="Mergi la Dashboard">
            <i data-lucide="layout-dashboard" class="mr-3 w-5 h-5 shrink-0" aria-hidden="true"></i> Dashboard
        </a>
        <a href="/membri" class="flex items-center justify-center py-2.5 px-3 hover:bg-slate-700 dark:hover:bg-slate-600 rounded transition focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-slate-900 dark:focus:ring-offset-slate-800" aria-label="Mergi la Management Membri">
            <i data-lucide="users" class="mr-3 w-5 h-5 shrink-0" aria-hidden="true"></i> Membri
        </a>
        <a href="/registru-interactiuni" class="flex items-center justify-center py-2.5 px-3 hover:bg-slate-700 dark:hover:bg-slate-600 rounded transition focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-slate-900 dark:focus:ring-offset-slate-800" aria-label="Mergi la Registru Interacțiuni">
            <i data-lucide="phone-call" class="mr-3 w-5 h-5 shrink-0" aria-hidden="true"></i> Registru Interacțiuni
        </a>
        <a href="/registratura" class="flex items-center justify-center py-2.5 px-3 hover:bg-slate-700 dark:hover:bg-slate-600 rounded transition focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-slate-900 dark:focus:ring-offset-slate-800" aria-label="Mergi la Registratura">
            <i data-lucide="file-text" class="mr-3 w-5 h-5 shrink-0" aria-hidden="true"></i> Registratura
        </a>
        <a href="/voluntariat" class="flex items-center justify-center py-2.5 px-3 hover:bg-slate-700 dark:hover:bg-slate-600 rounded transition focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-slate-900 dark:focus:ring-offset-slate-800" aria-label="Mergi la Voluntariat">
            <i data-lucide="heart-handshake" class="mr-3 w-5 h-5 shrink-0" aria-hidden="true"></i> Voluntariat
        </a>
        <a href="/ajutoare-bpa" class="flex items-center justify-center py-2.5 px-3 hover:bg-slate-700 dark:hover:bg-slate-600 rounded transition focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-slate-900 dark:focus:ring-offset-slate-800" aria-label="Mergi la Ajutoare BPA">
            <i data-lucide="package" class="mr-3 w-5 h-5 shrink-0" aria-hidden="true"></i> Ajutoare BPA
        </a>
        <a href="/activitati" class="flex items-center justify-center py-2.5 px-3 hover:bg-slate-700 dark:hover:bg-slate-600 rounded transition focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-slate-900 dark:focus:ring-offset-slate-800" aria-label="Mergi la Activități">
            <i data-lucide="activity" class="mr-3 w-5 h-5 shrink-0" aria-hidden="true"></i> Activitati
        </a>
        <a href="/fundraising" class="flex items-center justify-center py-2.5 px-3 hover:bg-slate-700 dark:hover:bg-slate-600 rounded transition focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-slate-900 dark:focus:ring-offset-slate-800" aria-label="Mergi la Fundraising">
