<?php
/**
 * View: Membri — Formular profil membru (shared partial)
 *
 * Functia render_formular_profil_membru() este folosita de profil.php
 * pentru editare in layout 3 coloane.
 *
 * Nota: Formularul de adaugare din dialog (membri/index.php) foloseste
 * in continuare app/views/partials/membri_form.php (render_formular_membru).
 * Acest fisier este versiunea pentru profilul membrului.
 */
function render_formular_profil_membru($membru, $eroare = '', $istoric_modificari = []) {
    $is_edit = !empty($membru);
    $membru = $membru ?: [];

    // Functie helper pentru a obtine valoarea campului
    ...
    <form id="form-membru-profil" method="post" action="/membru-profil?id=<?php echo $membru['id']; ?>"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <!-- Coloana 1: Nume, Prenume, Data nasterii, Date de contact, Acord GDPR -->
            <div class="space-y-4">
                <div class="bg-slate-50 dark:bg-gray-700/30 rounded-lg p-4 border border-slate-200 dark:border-gray-600">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="dosarnr" name="dosarnr" value="<?php echo $val('dosarnr'); ?>" maxlength="6"
                                       class="<?php echo $input_class; ?>"
                                       aria-label="Numar dosar (max. 6 caractere)">
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div>
                                <label for="datanastere" class="block text-sm font-medium text-slate-800 dark:text-gray-200 mb-1">Data Nasterii</label>
                                <input type="date" id="datanastere" name="datanastere" value="<?php echo $val('datanastere'); ?>"
                                       class="<?php echo $input_class; ?>">
                            </div>
                            <div>
                                <label for="locnastere" class="block text-sm font-medium text-slate-800 dark:text-gray-200 mb-1">Loc. Nasterii</label>
                                <input type="text" id="locnastere" name="locnastere" value="<?php echo $val('locnastere'); ?>"
                                       class="<?php echo $input_class; ?>">
                            </div>
                            <div>
                                <label for="judnastere" class="block text-sm font-medium text-slate-800 dark:text-gray-200 mb-1">Jud. Nasterii</label>
                ...
                <div class="bg-slate-50 dark:bg-gray-700/30 rounded-lg p-4 border border-slate-200 dark:border-gray-600">
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label for="telefonapartinator" class="block text-sm font-medium text-slate-800 dark:text-gray-200 mb-1">Telefon Apartinator</label>
                ...
                <div class="bg-slate-50 dark:bg-gray-700/30 rounded-lg p-4 border border-slate-200 dark:border-gray-600">
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label for="nume_apartinator" class="block text-sm font-medium text-slate-800 dark:text-gray-200 mb-1">Nume Apartinator</label>
                                <input type="text" id="nume_apartinator" name="nume_apartinator" value="<?php echo $val('nume_apartinator'); ?>"
                                       class="<?php echo $input_class; ?>">
                            </div>
                            <div>
                                <label for="prenume_apartinator" class="block text-sm font-medium text-slate-800 dark:text-gray-200 mb-1">Prenume Apartinator</label>
            ...
            <!-- Coloana 2: Act de identitate, Domiciliu, Documente generate, Istoric modificari -->
            <div class="space-y-4">
                <div class="bg-slate-50 dark:bg-gray-700/30 rounded-lg p-4 border border-slate-200 dark:border-gray-600">
                    <h3 class="text-md font-semibold text-slate-900 dark:text-white mb-4 flex items-center">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label for="cinumar" class="block text-sm font-medium text-slate-800 dark:text-gray-200 mb-1">Numar C.I.</label>
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <div>
                                <label for="cidataexp" class="block text-sm font-medium text-slate-800 dark:text-gray-200 mb-1">C.I. data expirarii</label>
                ...
                <!-- Istoric modificari pentru profil membru -->
                <div class="bg-slate-50 dark:bg-gray-700/30 rounded-lg p-4 border border-slate-200 dark:border-gray-600">
                    <h3 class="text-md font-semibold text-slate-900 dark:text-white mb-4 flex items-center">
                    ...
                    <?php if (empty($istoric_modificari)): ?>
                        <p class="text-sm text-slate-600 dark:text-gray-400">Nu exista inregistrari in istoricul de modificari pentru acest membru.</p>
                    <?php else: ?>
                ...
                <div class="bg-slate-50 dark:bg-gray-700/30 rounded-lg p-4 border border-slate-200 dark:border-gray-600">
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <div>
                                <label for="judet_domiciliu" class="block text-sm font-medium text-slate-800 dark:text-gray-200 mb-1">Judet</label>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label for="primaria" class="block text-sm font-medium text-slate-800 dark:text-gray-200 mb-1">Primaria de Domiciliu</label>
                ...
                <div class="bg-slate-50 dark:bg-gray-700/30 rounded-lg p-4 border border-slate-200 dark:border-gray-600">
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <div>
                                <label for="ceexp" class="block text-sm font-medium text-slate-800 dark:text-gray-200 mb-1">Data Expirarii</label>
                ...
                <div class="bg-slate-50 dark:bg-gray-700/30 rounded-lg p-4 border border-slate-200 dark:border-gray-600">
                    ...
                    <div>
                        ...
                        <div class="mb-3 p-2 bg-white dark:bg-gray-800 rounded border border-slate-200 dark:border-gray-600">
                            <p class="text-sm text-slate-700 dark:text-gray-300 mb-1">Fisier actual:</p>
        ...
        if (cnpInput && cnpEroare) {
            cnpInput.addEventListener('input', function() {
                ...
                if (val.length > 0 && val.length !== 13) {
                    cnpEroare.textContent = 'CNP-ul trebuie sa contina exact 13 cifre.';
            ...
            if (form) {
                form.addEventListener('submit', function(e) {
                    ...
                    if (val.length > 0 && val.length !== 13) {
                        cnpEroare.textContent = 'CNP-ul trebuie sa contina exact 13 cifre. Verificarea se va face pe server.';
                        cnpEroare.classList.remove('hidden');
                        cnpInput.setAttribute('aria-invalid', 'true');
                    }
                });
