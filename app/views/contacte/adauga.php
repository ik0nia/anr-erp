<?php
/**
 * View: Contacte — Formular adaugare
 *
 * Variabile disponibile: $eroare, $tipuri, $contact (array POST sau gol)
 */
$c = $contact ?? [];
?>
...
<main id="main-content" class="flex-1 flex flex-col overflow-hidden" role="main">
    <header class="bg-white dark:bg-gray-800 shadow p-4 flex flex-wrap justify-between items-center gap-2"><meta charset="utf-8">
        ...
        <a href="/contacte" class="text-amber-600 dark:text-amber-400 hover:underline focus:ring-2 focus:ring-amber-500 rounded">← Înapoi</a>
    </header>
    <div class="p-6 overflow-y-auto flex-1 max-w-2xl">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-slate-200 dark:border-gray-700 p-6">
            <form method="post" action="/contacte/adauga">
                <?php echo csrf_field(); ?>
