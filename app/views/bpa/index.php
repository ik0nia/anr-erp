                ...
                <section class="bg-white dark:bg-gray-800 rounded-lg shadow border border-slate-200 dark:border-gray-700 p-4" aria-labelledby="titlu-tabele-bpa">
                    ...
                    <form method="post" action="/ajutoare-bpa" id="form-tabel-bpa">
                        ...
                        <div class="mt-4 p-3 bg-slate-50 dark:bg-gray-700/50 rounded-lg">
                            ...
                            <input type="hidden" name="predare_sediul" value="0"><label class="inline-flex items-center gap-2 mr-4"><input type="checkbox" name="predare_sediul" value="1" <?php echo ($tabel_edit && $tabel_edit['predare_sediul']) ? 'checked' : ''; ?> class="rounded border-slate-300 dark:border-gray-500 text-amber-600 focus:ring-amber-500"> Predare la sediu</label>
                            <input type="hidden" name="predare_centru" value="0"><label class="inline-flex items-center gap-2 mr-4"><input type="checkbox" name="predare_centru" value="1" <?php echo ($tabel_edit && $tabel_edit['predare_centru']) ? 'checked' : ''; ?> class="rounded border-slate-300 dark:border-gray-500 text-amber-600 focus:ring-amber-500"> Predare la centru</label>
                            <input type="hidden" name="livrare_domiciliu" value="0"><label class="inline-flex items-center gap-2"><input type="checkbox" name="livrare_domiciliu" value="1" <?php echo ($tabel_edit && $tabel_edit['livrare_domiciliu']) ? 'checked' : ''; ?> class="rounded border-slate-300 dark:border-gray-500 text-amber-600 focus:ring-amber-500"> Livrare la domiciliu</label>
                        </div>
